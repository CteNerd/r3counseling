...
<strong style={{ color: '#839abf' }}>Duration: 3 Hour; Fee: $145 Group Setting {<br/>}Meets Once Monthly</strong>
<br /><br />
...
<strong style={{ color: '#839abf' }}>Duration: 1 Hour; Fee: $75 Individual Setting</strong>
</p>
    </div>
)
