        ...
        <div>
          ...
          <div style={{ display: props.isMobile ? "block" : "flex" }}>
            <div className="help-app-container">
              <h5>My GCal App</h5>
              <p>
                For youth in the state of Georgia to have free access to a
                mental health counselor 24 hours a day/7 days per week. Youth
                can chat via text message or phone
              </p>
              <div>
            ...
            <div className="help-app-container">
              ...
              <p>
                ...
                immediate support and GPS tracking capability to meet
                individuals at their location
              </p>
              <div>
